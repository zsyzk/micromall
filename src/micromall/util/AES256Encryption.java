...
/**
 * 
 * @ClassName:     AES256Encryption.java
 * @Description:   TODO(用一句话描述该文件做什么) 
 * 
 * @author         zhangsy
 * @version        V1.0  
 * @Date           2016-6-13 上午10:15:25
 */
public class AES256Encryption {
	...
	public static byte[] initkey() throws Exception {
		...
		// -42 37 -22 -65 115 -30 11 54 66 -66 -82 78 42 11 98 45

		return new byte[] { 8, 8, 4, 17, 2, 21, 8, 1, 77, 32, 11, 31, 45, 32,
				9, 7 };
