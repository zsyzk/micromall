...
public class MD5 {
	 ...
	 * 
	 */
	public String getMD5ofStrTwo(String str, int count) {
		for (int i = 0; i < count; i++) {
			md5Value = getMD5ofStr(str);
			str = md5Value;
		}
		return md5Value;
	}
	...
	public static void main(String args[]) {
		MD5 md5 = new MD5();
		System.out.println(md5.getMD5ofStrTwo("admin", 5));
		// System.out.println(md5.getMD5ofStr("null").substring(0, 10));
	}
}