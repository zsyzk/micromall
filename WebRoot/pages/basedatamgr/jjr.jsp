...
<script src="<%=basePath%>js/basedatamgr/jjr.js" type="text/javascript"></script>
	...
	<div id="div_jjr">
		<div class="place">
			...
			<ul class="placeul">
				...
				<li><a href="javascript:void(0)">节假日数据</a></li>
			</ul>
		</div>
		...
		<div class="rightinfo">
			...
			<table class="tablelist">
				<thead>
					<tr>
						<th width="70" pn="holidayid">编号</th>
						<th width="200" pn="msg">名称</th>
						<th width="150" pn="date">日期</th>
						<th width="150" pn="year">年份</th>
					</tr>
				</thead>
				<tbody />
			</table>
