...
<script src="<%=basePath%>js/basedatamgr/zwt.js" type="text/javascript"></script>
	...
	<div id="div_zwt">
		<div class="place">
			...
			<ul class="placeul">
				...
				<li><a href="javascript:void(0)">座位图数据</a></li>
			</ul>
		</div>
		...
		<div class="rightinfo">
			...
			<table class="tablelist">
				<thead>
					<tr>
						<th width="70" pn="zwtid">编号</th>
						<th width="100" pn="zws">座位数量</th>
						<th width="500" pn="zwt">座位图</th>
					</tr>
				</thead>
				<tbody />
			</table>
