...
<script src="<%=basePath%>js/basedatamgr/zdwzgl.js" type="text/javascript"></script>
		...
		if(''!=action){
			...
			for(var a in as){
				if(as[a] == "09"){
					...
					$('<li><label>&nbsp;</label><input id="saveMapPoint" name="" type="button" class="scbtn" value="保存"/></li>').insertBefore("#s2");
				}
			}
...
<body>
	...
	<div class="place">
		...
		<ul class="placeul">
			...
			<li><a href="javascript:void(0)">站点位置管理</a></li>
		</ul>
	</div>


	<div class='itab'><ul id='tabTarget'><li><a href='#location' class='selected'>站点位置</a></li><li><a href='#mapLocation'>站点地图位置</a></li></ul></div>
	...
	<div id='location' class='tabson' >
			<div class="formbody">
					...
					<div id="source" style="border:1px solid #ccc;width:120px;height:400px;float:left;margin:5px;">
						...
						<div id="sourceDetail" style="height: 380px;overflow: auto;"></div>
					</div>
					 <div style="overflow:auto;width:800px;height: 400px;border:1px solid #ccc;">
						<div id="target" style="position:relative;overflow:auto;width:1080px;height:1920px;float:left;margin:5px;"></div>
					</div>		
			</div>
	</div> 
	<div id='mapLocation' class='tabson' >
	    ...
	    <li id="s2"><label>经度:</label><input id="mapX" type="text" class="scinput" readonly="readonly" /></li>
