...
<script src="<%=basePath%>js/basedatamgr/xianlu.js"
	...
	<div id="div_xl">
		<div class="place">
			...
			<ul class="placeul">
				...
				<li><a href="javascript:void(0)">线路数据</a></li>
			</ul>
		</div>
		...
		<div class="rightinfo">
			...
			<table class="tablelist">
				<thead>
					<tr>
						<th width="50"></th>
						<th width="100" pn="xlid">编号</th>
						<th width="450" pn="xlmc">线路名称</th>
						<th width="450" pn="xlfx">线路方向</th>
						<th width="200" pn="qsdqmc">起始站点</th>
						<th width="200" pn="zddqmc">终点站点</th>
					</tr>
				</thead>
				<tbody />
			</table>
