...
<script src="<%=basePath%>js/basedatamgr/zhandian.js"
			...
			<table class="tablelist">
				<thead>
					<tr>
						...
						<th width="200" pn="zdbaseName">站点名称</th>
						<th width="150" pn="bcrq">班次日期</th>
						<th width="150" pn="ccsj">乘车时间</th>
						<th width="120" pn="type">站点类型</th>
						<th width="120" pn="xztp">套票购买</th>
					</tr>
				</thead>
				<tbody />
			</table>
