...
<script src="<%=basePath%>js/order/order_all.js" type="text/javascript"></script>
...
<body>
	<div id="div_orders_all">
		<div class="place">
			<span>位置：</span>
			<ul class="placeul">
				<li><a href="javascript:void(0)">车票订单</a></li>
				<li><a href="javascript:void(0)">全部订单</a></li>
			</ul>
		</div>
		...
		<div class="rightinfo">
			...
			<table class="tablelist">
				<thead>
					<tr>
						<th width="70" pn="cpOrderId">编号</th>
						<th width="120" pn="orderNum"  align="left">订单号</th>
						<th width="120" pn="userId">用户</th>
						<th width="120" pn="buyDate">购买时间</th>
						<th width="120" pn="moneyType">货币类型</th>
						<th width="120" pn="status">订单状态</th>
						<th width="120" pn="cpSum">车票数</th>
						<th width="120" pn="price">金额</th>
					</tr>
				</thead>
				<tbody />
			</table>
