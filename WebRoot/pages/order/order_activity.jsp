...
<script src="<%=basePath%>js/order/order_activity.js"
...
<body>
	<div id="div_orders_activity">
		<div class="place">
			<span>位置：</span>
			<ul class="placeul">
				<li><a href="javascript:void(0)">车票订单</a></li>
				<li><a href="javascript:void(0)">有效订单</a></li>
			</ul>
		</div>
