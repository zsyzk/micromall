...
<script src="<%=basePath%>js/appmgr/cyxl.js" type="text/javascript"></script>
	...
	<div id="cyxl">
		<div class="place">
			...
			<ul class="placeul">
				...
				<li><a href="javascript:void(0)">常用线路管理</a></li>
				<li><a href="javascript:void(0)">常用线路</a></li>
			</ul>
		</div>
		...
		<div class="rightinfo">
			...
			<table class="tablelist">
				<thead>
					<tr>
						<th width="70" pn="cyxlid">编号</th>
						<th width="120" pn="userid">用户</th>
						<th width="120" pn="savedata">日期</th>
						<th width="150" pn="xlmc">线路名称</th>
						<th width="120" pn="sczdmc">上车站点</th>
						<th width="120" pn="xczdmc">下车站点</th>
					</tr>
				</thead>
				<tbody />
			</table>
