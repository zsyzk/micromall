...
(function(c) {
	...
	var a = {
		...
		onSelect : function(h) {
			...
			var t = h.type;
			var iconClass = "";
			if(-1!=t.indexOf("jpg") || -1!=t.indexOf("gif") || -1!=t.indexOf("png")){
				iconClass = "imageIcon";
			}
			if (i.itemTemplate == false) {
				i.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">		<div class="icon '+iconClass+'" >	<a href="javascript:$(\'#${instanceID}\').uploadify(\'cancel\', \'${fileID}\')">X</a>										<span class="fileName">${fileName} &nbsp;&nbsp;(${fileSize})</span><span class="data">未上传</span></div>			</div>';
			}
